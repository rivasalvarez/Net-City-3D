...
public class tutorial01 : MonoBehaviour {
	...
	void Start () {
		...
		if (playerScript.getLevelLoaded ()) {
			...
			for(int i = 0; i < tmp; i++)
			{
				obj = Instantiate (Resources.Load ("Models/Buildings/buildingPrefab/corporatePre", typeof(GameObject))) as GameObject;
			...
			for(int i = 0; i < tmp;i++)
			{
				obj = Instantiate (Resources.Load ("Models/Roads/roadPre/roadPre", typeof(GameObject))) as GameObject;
			...
			for(int i = 0; i < tmp; i++)
			{
				obj = Instantiate (Resources.Load ("Models/Security/SecurityPre/gatePre", typeof(GameObject))) as GameObject;
			...
			{
				print ("CARS");
				 obj = Instantiate (Resources.Load ("Models/Cars/carPrefab/firetruckPre", typeof(GameObject))) as GameObject;
				tmpObj = obj;
